...
export default function Tela5(props){
    ...
    const array = [
      require('../../../imagens/Maca/5.png'),
      require('../../../imagens/Maca/6.png'),
      require('../../../imagens/Maca/7.png'),
      require('../../../imagens/Maca/8.png'),
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela6Top9',{metros:valoropt}); 
    }
    function Voltar(){
      navigation.navigate('Tela4Top9'); 
    }
