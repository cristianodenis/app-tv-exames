...
export default function Tela6(props){
    ...
    const array = [
      require('../../../imagens/Maca/1.png'),
      require('../../../imagens/Maca/2.png'),
      require('../../../imagens/Maca/3.png'),
      require('../../../imagens/Maca/4.png'),
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela7Top9',{metros:valoropt}); 
    }
    function Voltar(){
      navigation.navigate('Tela5Top9'); 
    }
