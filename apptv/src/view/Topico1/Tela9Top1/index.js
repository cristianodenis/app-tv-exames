...
export default function Tela9(props){
    ...
    const array = [
      require('../../../imagens/menino/1.png'),
      require('../../../imagens/menino/2.png'),
      require('../../../imagens/menino/3.png'),
      require('../../../imagens/menino/4.png'),
      require('../../../imagens/menino/5.png'),
      require('../../../imagens/menino/6.png'),
      require('../../../imagens/menino/7.png')
   ]
    
      function ImgAleatorias(o) {
        for(var j, x, i = o.length; i; j = parseInt(Math.random() * i), x = o[--i], o[i] = o[j], o[j] = x);
          return setUri0(o[0]),setUri1(o[1]),setUri2(o[2]),setUri3(o[3]),
          setUri4(o[4]),setUri5(o[5]),setUri6(o[6])
      };
    ...
    function Avancar(){
      navigation.navigate('Tela10Top1',{metros:valoropt}); 
      
    }
    function Voltar(){
      navigation.navigate('Tela8Top1'); 
    }
