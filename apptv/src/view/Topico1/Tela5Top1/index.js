...
export default function Tela5(props){
    ...
    const array = [
      require('../../../imagens/menino/8.png'),
      require('../../../imagens/menino/9.png'),
      require('../../../imagens/menino/10.png'),
      require('../../../imagens/menino/11.png'),
      require('../../../imagens/menino/12.png'),
      require('../../../imagens/menino/13.png'),
      require('../../../imagens/menino/14.png')
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela6Top1',{metros:valoropt}); 
      
    }
    function Voltar(){
      navigation.navigate('Tela4Top1'); 
    }
