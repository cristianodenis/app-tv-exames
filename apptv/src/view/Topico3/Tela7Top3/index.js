...
export default function Tela7(props){
    ...
    const array = [
      require('../../../imagens/Numero-5/1.png'),
      require('../../../imagens/Numero-5/2.png'),
      require('../../../imagens/Numero-5/3.png'),
      require('../../../imagens/Numero-5/4.png'),
      require('../../../imagens/Numero-5/5.png')
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela8Top3',{metros:valoropt}); 
    }
    function Voltar(){
      navigation.navigate('Tela6Top3',{metros:valoropt}); 
    }
