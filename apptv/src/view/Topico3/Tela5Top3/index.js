...
export default function Tela5(props){
    ...
    const array = [
      require('../../../imagens/Numero-5/6.png'),
      require('../../../imagens/Numero-5/7.png'),
      require('../../../imagens/Numero-5/8.png'),
      require('../../../imagens/Numero-5/9.png'),
      require('../../../imagens/Numero-5/10.png')
   ]
    ...
    function Voltar(){
      navigation.navigate('Tela4Top3',{metros:valoropt}); 
    }
