...
export default function Tela8(props){
    ...
    const array = [
      require('../../../imagens/Letra-C/1.png'),
      require('../../../imagens/Letra-C/2.png'),
      require('../../../imagens/Letra-C/3.png'),
      require('../../../imagens/Letra-C/4.png'),
      require('../../../imagens/Letra-C/5.png'),
      require('../../../imagens/Letra-C/6.png'),
      require('../../../imagens/Letra-C/7.png'),
      require('../../../imagens/Letra-C/8.png')
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela9Top6',{metros:valoropt}); 
    }
    function Voltar(){
      navigation.navigate('Tela7Top6',{metros:valoropt}); 
    }
    ...
    return(
      ...
      <SafeAreaView style={{flex:1,backgroundColor:'black'}}>   
          <ImageBackground style={{width:'100%',height:'100%',position:'absolute'}} source={require('../../../imagens/imagem1.png')}></ImageBackground>
          ...
          <View style={{flex:1,flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
            ...
            <Image style={{width:largura,height:altura}} source={`${uri4}`}/>
              <View style={{flexDirection:'column'}}>
                ...
                <View style={{width:largura,height:5,backgroundColor:'white',marginTop:3}}></View>
              </View>
