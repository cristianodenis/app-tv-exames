...
export default function Tela9(props){
    ...
    function Avancar(){
      navigation.navigate('Topico6',{metros:valoropt}); 
    }
    function Voltar(){
      navigation.navigate('Tela8Top6',{metros:valoropt}); 
    }
    ...
    return(
      ...
      <SafeAreaView style={{flex:1,backgroundColor:'black'}}>   
          <ImageBackground style={{width:'100%',height:'100%',position:'absolute'}} source={require('../../../imagens/imagem2.png')}></ImageBackground>
