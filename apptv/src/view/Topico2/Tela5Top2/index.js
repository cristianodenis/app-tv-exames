...
export default function Tela5(props){
    ...
    const array = [
      require('../../../imagens/Letra-E/5.png'),
      require('../../../imagens/Letra-E/6.png'),
      require('../../../imagens/Letra-E/7.png'),
      require('../../../imagens/Letra-E/8.png')
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela6Top2',{metros:valoropt}); 
    }
    function Voltar(){
      navigation.navigate('Tela4Top2'); 
    }
