...
export default function Tela6(props){
    ...
    const array = [
      require('../../../imagens/Letra-E/1.png'),
      require('../../../imagens/Letra-E/2.png'),
      require('../../../imagens/Letra-E/3.png'),
      require('../../../imagens/Letra-E/4.png')
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela7Top2',{metros:valoropt}); 
      
    }
    function Voltar(){
      navigation.navigate('Tela5Top2'); 
    }
    ...
    return(
      ...
      <SafeAreaView style={{flex:1}}>   
        ...
        <View style={{justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontSize:23,color:'black',marginBottom:5}}>{optotipos}</Text>
        </View>
