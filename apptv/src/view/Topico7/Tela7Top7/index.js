...
export default function Tela7(props){
    ...
    const array = [
      require('../../../imagens/Barquinho/8.png'),
      require('../../../imagens/Barquinho/9.png'),
      require('../../../imagens/Barquinho/10.png'),
      require('../../../imagens/Barquinho/11.png'),
      require('../../../imagens/Barquinho/12.png'),
      require('../../../imagens/Barquinho/13.png'),
      require('../../../imagens/Barquinho/14.png')
   ]
    ...
    function Avancar(){
      navigation.navigate('Tela8Top7',{metros:valoropt}); 
    }
    function Voltar(){
      navigation.navigate('Tela6Top7',{metros:valoropt}); 
    }
